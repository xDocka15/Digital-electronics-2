...
ISR(TIMER1_OVF_vect)
{
  ...
  if (i == 1){
    ...
    i = 1;
    uart_puts("humid  ");
    itoa(air.humid_int,string,10); uart_puts(string);
    
    uart_puts(",");
    itoa(air.humid_dec,string,10); uart_puts(string);
    uart_puts("\r\n");
    uart_puts("temp  ");
    itoa(air.temp_int,string,10); uart_puts(string);
    
    uart_puts(",");
    itoa(air.temp_dec,string,10); uart_puts(string);
    uart_puts("\r\n");
  }
